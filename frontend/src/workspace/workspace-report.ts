...
export const buildWorkspaceReport = ({
  ...
  [
    ...
    `Execution mode: ${integrationStatus.mode}`,
    `Binary OCR readiness: ${integrationStatus.readiness.binaryOcr}`,
    `Field extraction readiness: ${integrationStatus.readiness.fieldExtraction}`,
    `Decision summary readiness: ${integrationStatus.readiness.decisionSummary}`,
